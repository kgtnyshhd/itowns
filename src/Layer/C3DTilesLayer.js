...
class C3DTilesLayer extends GeometryLayer {
     ...
     * threshold at which child nodes of the current node will be loaded and added to the scene. Deaul
     * @param {Number} [config.cleanupDelay=1000] The time after which a tile content (and its children) are removed
     * from the scene.
    ...
    constructor(id, config, view) {
        ...
        this.overrideMaterials = config.overrideMaterials !== undefined ? config.overrideMaterials : false;
