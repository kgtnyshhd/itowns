...
class GlobeControls extends THREE.EventDispatcher {
    constructor(view, placement, options = {}) {
        ...
        this.minPolarAngle = options.minPolarAngle ? THREE.MathUtils.degToRad(options.minPolarAngle) : THREE.MathUtils.degToRad(0.5);
        this.maxPolarAngle = options.maxPolarAngle ? THREE.MathUtils.degToRad(options.maxPolarAngle) : THREE.MathUtils.degToRad(86);
